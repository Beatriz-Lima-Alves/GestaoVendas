        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="linha">
                        <p class="t-20">{{ __("Novo Funcionário") }}</p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                <div class="col">
                                    <!-- Name -->
                                    <div>
                                        <x-input-label for="name" :value="__('Nome')"  class=""/>
                            ...
                            <div class="row mt-2">
                                <div class="col">
                                    <!-- Password -->
                                    <div>
                                        <x-input-label for="password" :value="__('Senha')" class="" />
                                ...
                                <div class="col">
                                    <!-- Confirm Password -->
                                    <div class="">
                                        <x-input-label for="password_confirmation" :value="__('Confirme a senha')" class=""/>
                            ...
                            <div class="flex items-center justify-end mt-4">
                                ...
                                <button class="ms-4 purple-button">
                                    {{ __('Salvar') }}
                                </button>
                            </div>
                        </form>
...
{{--        <div class="relative w-full max-w-auto">--}}
...
{{--                </div>--}}
{{--                <div class="half">--}}
{{--                    <h1 class=" t-60-bold">Sistema de vendas</h1>--}}
{{--                    <h2 class=" t-40">Tecnológico e prático</h2>--}}
{{--                    <p class="pleft">Transforme vendas em sucesso e clientes em lealdade com o poder do nosso sistema de vendas. Voe mais alto, alcance mais longe e faça cada venda contar</p>--}}
{{--                </div>--}}

{{--                <div class="half-right">--}}
{{--                    <h1 class="text-20 text-center">Cadastro de usuário</h1>--}}
{{--                    <form method="POST" action="{{ route('register') }}">--}}
{{--                        @csrf--}}
...
{{--                        <!-- Confirm Password -->--}}
{{--                        <div class="mt-4">--}}
{{--                            <x-input-label for="password_confirmation" :value="__('Confirme a senha')" class="text-white"/>--}}
