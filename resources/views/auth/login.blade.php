    ...
    <div class="relative min-h-screen flex flex-col selection:bg-[#FF2D20] selection:text-white">
        <div class="relative w-full max-w-auto">
            ...
            <main class="main-register">
                ...
                <div class="half">
                    <h1 class=" t-60-bold">Seja bem-vindo!</h1>
                    <p class="pleft">Faça da sua jornada de vendas uma experiência memorável</p>
                </div>

                <div class="half-right">
                    <h1 class="t-40 text-center">Login</h1>
                    ...
                    <!-- Email Address -->
                        ...
                        <div class="block mt-4">
                            <label for="remember_me" class="inline-flex items-center">
                                ...
                                <span class="ms-2 text-sm text-white">{{ __('Lembre de mim') }}</span>
                            </label>
                        </div>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <x-primary-button class="ms-3 bg-purple-btn" style="background-color: #64B83E">
                                {{ __('Log in') }}
                            </x-primary-button>
                        </div>
                    </form>
            ...
            {{--                    <footer class=" text-center text-sm dark:text-white/70 foote-home">--}}
