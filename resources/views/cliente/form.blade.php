        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="linha">
                        <p class="t-20">{{ __("Novo Cliente") }}</p>
                    </div>
                    <hr style="margin-bottom: 20px;">
                    <form action="{{ route('cliente.store') }}" class="text-black" method="post">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                ...
                                <x-text-input id="cpf" class="block mt-1 w-full text-black" type="text" name="cpf" :value="old('cpf')" required />
                                <x-input-error :messages="$errors->get('cpf')" class="mt-2 text-black" />
                            </div>

                            <div>
                                <x-input-label for="telefone" :value="__('Telefone')" class="text-black"/>
                                <x-text-input id="telefone" class="block mt-1 w-full text-black" type="text" name="telefone" :value="old('telefone')" required />
                        ...
                        <div class="grid grid-cols-3 gap-x-4">
                            <div>
                                ...
                                <x-text-input id="cep" class="block mt-1 w-full text-black" type="text" name="cep" :value="old('cep')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="logradouro" class="block mt-1 w-full text-black" type="text" name="logradouro" :value="old('logradouro')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="numero" class="block mt-1 w-full text-black" type="text" name="numero" :value="old('numero')" required />
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                ...
                                <x-text-input id="complemento" class="block mt-1 w-full text-black" type="text" name="complemento" :value="old('complemento')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="bairro" class="block mt-1 w-full text-black" type="text" name="bairro" :value="old('bairro')" required />
                        ...
                        <div class="grid grid-cols-2 gap-x-4">
                            <div>
                                ...
                                <x-text-input id="localidade" class="block mt-1 w-full text-black" type="text" name="localidade" :value="old('localidade')" required />
                                <x-input-error :messages="$errors->get('localidade')" class="mt-2 text-black" />
                            </div>

                            <div>
                                <x-input-label for="uf" :value="__('UF')" class="text-black"/>
                                <x-text-input id="uf" class="block mt-1 w-full text-black" type="text" name="uf" :value="old('uf')" required />
